...
raw_data = LOAD 's3://testbuckettechcovery/movies_data.csv' using PigStorage(',');
...
STORE C1 into 's3://testbuckettechcovery/task1_result.csv' using PigStorage(',');
...
-- store the result into a csv file
STORE C2 into 's3://testbuckettechcovery/task2_result.csv' using PigStorage(',');
...
-- store the result into a csv file
STORE C3 into 's3://testbuckettechcovery/task3_result.csv' using PigStorage(',');
